      ...
      >
        <div class="container"> 
          <div class="row justify-content-center">
            <div class="col-lg-8">
              ...
              <form action="makeapplicationletter.php" method="post" class="offset-md-1 col-md-12" style="z-index:2; background-color: #f7f7f7; border-radius:20px; margin-top:-15%">
        <h1>Create your Application Letter</h1>
        <p>Fill out the details below and the Application Letter will be downloaded</p>
        <div class="row mb-2">
          <div class="col-md-6">
            <input
              type="text"
        ...
        <button class="main-btn wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="1.1s" type="submit">
          Generate Application Letter
            ...
            <div class="col-lg-4">
              <img src="photos/undraw_remotely_2j6y.svg" alt="hero" style="margin-top: 30%;"  />
              <br><br><br><br><br><br>
              <img src="photos/undraw_researching_22gp.svg" alt="hero" /> 
            </div>
          </div>
