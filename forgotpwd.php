...
<body >
    ...
    <form action="password-reset-token.php" method="post" style="background-color: #f7f7f7; border-radius:20px; margin-top:-10%;">
        ...
        <div class="container" style="background-color:#f1f1f1">
            <input class="main-btn" data-scroll-nav="0" type="submit" name="password-reset-token" class="Regbtn">
        </div>
            ...
            <div class="col-lg-6">
              <img src="photos/undraw_Code_review_re_woeb.svg" alt="hero" style="margin-top: 30%;"  />
